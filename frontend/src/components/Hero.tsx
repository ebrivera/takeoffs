    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 py-24 md:py-32">
        <div className="grid items-center gap-16 lg:grid-cols-2">
          {/* Left - Copy */}
          <div className="max-w-xl rounded-2xl border border-white/65 bg-white/68 p-6 shadow-[0_16px_48px_rgba(17,17,17,0.08)] backdrop-blur-sm sm:p-8 md:p-10">
            <h1 className="animate-fade-up delay-100 text-4xl font-extrabold leading-[1.08] tracking-tight text-navy-950 sm:text-5xl lg:text-6xl">
              Cost estimates{" "}
            ...
            <p className="animate-fade-up delay-200 mt-6 max-w-md text-lg leading-relaxed text-navy-700">
              Cantena reads your construction plans and automatically generates
            ...
            >
              ...
              <a
                href="#how-it-works"
                className="inline-flex items-center justify-center gap-2 px-6 py-3.5 text-sm font-medium text-navy-800 transition-colors hover:text-navy-950"
              >
                See How It Works
                <svg
                  width="12"
            ...
            <div className="relative">
              ...
              <div className="rounded-lg border border-white/10 bg-navy-900/60 p-6 shadow-2xl shadow-black/40 backdrop-blur-sm">
                ...
                <div className="mb-5 flex items-center justify-between">
                  ...
                  <span className="rounded border border-emerald-300/40 bg-emerald-500/20 px-2 py-0.5 font-mono text-[10px] font-semibold text-emerald-200">
                    COMPLETE
                  </span>
                </div>
                ...
                <div className="mb-2 grid grid-cols-4 gap-3 border-b border-white/5 pb-2">
                  <span className="font-mono text-[10px] font-semibold uppercase tracking-wider text-navy-300">
                    Item
                  </span>
                  <span className="font-mono text-[10px] font-semibold uppercase tracking-wider text-navy-300">
                    Qty
                  ...
                  <span className="text-right font-mono text-[10px] font-semibold uppercase tracking-wider text-navy-300">
                    Cost
                  </span>
                </div>
                ...
                {[
                  ...
                  >
                    <span className="text-sm text-white/95">{row.item}</span>
                    <span className="font-mono text-sm text-navy-100">
                      {row.qty}
                    </span>
              ...
              <div className="absolute -right-4 -top-4 rounded border border-blueprint-400/30 bg-navy-900/80 px-3 py-2 shadow-lg backdrop-blur-sm">
                <div className="font-mono text-[10px] text-navy-200">
                  Processing Time
                </div>
                <div className="font-mono text-lg font-bold text-blueprint-200">
                  2m 14s
                </div>
              </div>
            </div>
